...
❔ **Để biết cách sử dụng bot này, vui lòng nhấp vào » ❓ Nút Hướng dẫn Cơ bả!**""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    ),fficial Group", url=f"https://t.me/{GROUP_SUPPORT}"
                    ),
                    InlineKeyboardButton(
                ...
                [
                    InlineKeyboardButton(
                        "🌐 Mã nguồn", url="https://github.com/levina-lab/VeezMusic"
                    )
                ],
            ]
        ),
